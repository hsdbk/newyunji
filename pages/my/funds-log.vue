<template>
	...
	<view class="funds-log-container" enablePullDownRefresh="true">
		...
		<view class="net-change-section">
			...
			<view class="activity-items">
				<view class="amount-row">
					<image class="amount-row-icon" :src="$getStaticSrc('/static/my/funds-c.png')" mode="aspectFit"></image>
					<view class="amount-content">
						<view class="income-amount">+{{ sum_add_money }}</view>
						<view class="amount-label">本月收入</view>
					</view>
				</view>
				<view class="amount-row">
					<image class="amount-row-icon1" :src="$getStaticSrc('/static/my/funds-m.png')" mode="aspectFit"></image>
					<view class="amount-content">
						<view class="expense-amount">{{ sum_sub_money }}</view>
						<view class="amount-label">本月支出</view>
					</view>
				</view>
			</view>
		</view>
		...
		<up-tabs class="filter-section" lineHeight="4rpx" :itemStyle="{ width: '20%', height: '80rpx' }"
			:inactiveStyle="{ fontSize: '24rpx', color: '#a4a4a4' }"
			:activeStyle="{ fontSize: '30rpx', color: '#FF481C' }" :list="list" lineWidth="123rpx" lineColor="#FF481C"
			:current="tabs" @change="changeFilterType"></up-tabs>
		...
		<view class="transaction-list">
			...
			<view class="transaction-item" v-for="(item, index) in log" :key="index">
				<view class="transaction-icon">
					...
					<image v-else :src="$getStaticSrc('/static/my/fee.png')" mode="aspectFit"></image>
				</view>
